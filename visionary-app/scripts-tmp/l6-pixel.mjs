...
mkdirSync("docs/Frontend(Head Of Product Agent)/l6-shots", { recursive: true });
...
for (const route of ROUTES) {
  ...
  for (const v of WIDTHS) {
    ...
    await page.screenshot({ path: `docs/Frontend(Head Of Product Agent)/l6-shots/${name}-${v.tag}.png` });
