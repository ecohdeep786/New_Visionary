  ...
  return (
    <header className="flex items-center gap-2 h-16 px-4 lg:px-8 bg-white border-b border-[#dadce0]/60 shrink-0 z-30">
      ...
      <div className="flex-1 flex justify-center px-4">
        <div className="flex items-center gap-2 w-full max-w-[560px] h-10 px-5 bg-[#f1f3f4] rounded-full border border-transparent focus-within:bg-white focus-within:border-[#dadce0] focus-within:shadow-sm transition-all duration-200">
      ...
      <div className="flex items-center gap-0.5 shrink-0">
        ...
        {/* Help */}
        <button className="w-9 h-9 flex items-center justify-center text-[#5f6368] hover:bg-gray-100 rounded-full transition-colors duration-200 [font-family:'Google_Sans',_sans-serif]">
          <HelpCircle className="w-[18px] h-[18px]" />
        </button>
        {/* Globe */}
        <button className="w-9 h-9 hidden sm:flex items-center justify-center text-[#5f6368] hover:bg-gray-100 rounded-full transition-colors duration-200 [font-family:'Google_Sans',_sans-serif]">
          ...
          <div className="absolute right-0 top-12 w-64 bg-white rounded-2xl shadow-lg border border-[#dadce0]/40 py-2 z-50">
              ...
              <div className="px-4 py-3 border-b border-[#dadce0]/40">
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span className="px-2 py-0.5 bg-[#e8f0fe] text-[#1a73e8] rounded-full text-xs font-medium capitalize">{user?.role || "Member"}</span>
                </div>
                <div className="mt-3">
              ...
              {/* Menu items */}
              <Link to="/dashboard/home" className="flex items-center gap-3 px-4 py-2.5 hover:bg-gray-50 transition-colors">
                <LayoutDashboard className="w-[18px] h-[18px] text-[#5f6368]" />
                <span className="text-sm font-normal text-[#202124]">Dashboard</span>
              </Link>
              <Link to="/dashboard/learn" className="flex items-center gap-3 px-4 py-2.5 hover:bg-gray-50 transition-colors">
                <TrendingUp className="w-[18px] h-[18px] text-[#5f6368]" />
                <span className="text-sm font-normal text-[#202124]">Progress</span>
              </Link>
              <Link to="/dashboard/profile" className="flex items-center gap-3 px-4 py-2.5 hover:bg-gray-50 transition-colors">
              ...
              <div className="flex items-center gap-3 px-4 py-2 border-t border-[#dadce0]/40">
                <span className="text-xs text-[#5f6368] hover:text-[#1a73e8] cursor-pointer">Privacy</span>
                <span className="text-xs text-[#5f6368] hover:text-[#1a73e8] cursor-pointer">Terms</span>
              </div>
            </div>
          }
        </div>
