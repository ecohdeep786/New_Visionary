  ...
  return <header className="z-30 flex h-16 shrink-0 items-center gap-2 bg-[#ffffff] px-3 sm:px-5">
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-72 rounded-2xl p-2">
        ...
        <DropdownMenuItem onSelect={() => navigate('/dashboard/personalization')}>Personalization</DropdownMenuItem>
        <DropdownMenuItem onSelect={() => navigate('/dashboard/privacy')}>Privacy & consent</DropdownMenuItem>
