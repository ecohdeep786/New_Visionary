 ...
 */
export default function EmptyState({ icon: Icon, title, description, actionLabel, actionTo = "/dashboard/subscription", accent = "#4285F4" }) {
  return (
    <div className="bg-white rounded-3xl border border-[#dadce0]/60 p-10 text-center flex flex-col items-center">
      ...
      <h3 className="text-[18px] font-medium text-[#121317] mb-2">{title}</h3>
