  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <form
        ...
        className="flex items-center gap-2 px-4 bg-white rounded-full border border-[#dadce0] focus-within:border-[#4285F4]/40 transition-colors"
      >
        ...
        <input
          ...
          className="flex-1 bg-transparent text-sm text-[#121317] placeholder:text-[#5f6368] outline-none h-12"
        />
        <button
          type="submit"
      ...
      {saved && (
        <div className="flex items-center justify-between px-5 py-3 bg-[#e6f4ea] rounded-full">
          <span className="text-sm text-[#137333] flex items-center gap-2">
            <Check className="w-4 h-4" /> Question saved to your AGI
          </span>
          <Link
            to="/dashboard/ask"
            className="text-sm font-medium text-[#137333] hover:underline flex items-center gap-1"
          >
            View in AGI →
          </Link>
        </div>
