      ...
      {sent ? (
        <div key="success" className="animate-in fade-in-0 slide-in-from-bottom-2 duration-200 flex flex-col items-center gap-6 text-center">
          ...
          <div className="flex flex-col gap-2">
            <h2 className="text-2xl font-normal text-[#121317]">Check your messages</h2>
            <p className="text-sm text-[#5f6368] leading-relaxed max-w-sm">
              If an account is associated with <span className="font-medium text-[#121317]">{contact}</span>, we'll send your account details to your recovery contact.
            </p>
          </div>
