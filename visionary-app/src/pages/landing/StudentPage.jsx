...
const StudentHeroSection = React.memo(function StudentHeroSection() {
  ...
  const heroImage =
    "https://www.apple.com/v/education/k12/overview/a/images/overview/learning/modals/support__dvu93fbijf6u_large.jpg";
  ...
  return (
    ...
    >
      ...
      <h1 className="sr-only">
        Learning, to {HERO_WORDS[index].replace(".", "")}.
      </h1>
      ...
      <div
        className="
          ...
          sm:px-8
          sm:py-24
          md:min-h-[calc(100svh-75px)]
          md:px-10
          md:py-16
          xl:min-h-[calc(100svh-75px)]
          xl:px-0
          xl:py-0
        "
      >
          ...
          >
            ...
            >
              ...
              >
                ...
                <span
                  key={index}
                  className="hero-fade-up inline-block"
                >
                  {HERO_WORDS[index]}
                </span>
              </div>
              ...
              >
                Every concept you understand becomes the foundation
                for the next one — in the language you think in,
                for as long as you keep learning.
              </p>
            </div>
        ...
        {/* =======================================================
            DESKTOP ART-DIRECTED VERSION
            Activated only at xl.
           ======================================================= */}
      ...
      {/* =========================================================
          SMALL-SCREEN BOTTOM BREATHING SPACE

          Prevents the decorative SVG from visually colliding with
          the next section when the viewport is narrow.
         ========================================================= */}
      <div
        aria-hidden="true"
        className="
