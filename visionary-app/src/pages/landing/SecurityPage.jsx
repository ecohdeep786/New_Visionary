        ...
        <p className="mt-4 text-[13px] tracking-[0.24px]" style={{ color: "#5f6368" }}>
          Last updated: <strong style={{ color: "#121317" }}>{LEGAL_META.security.lastUpdated}</strong>
              ...
              <div className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-3 text-[14px]">
                ...
                <Link to="/privacy" className="inline-flex items-center gap-1.5 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1a73e8] focus-visible:ring-offset-2" style={{ color: C.blue }}>
                  Read Privacy
              ...
              <aside className="hidden lg:block">
                <div className="sticky top-24">
                  ...
                  <div className="mt-8 border-t pt-6" style={{ borderColor: C.border }}>
                    ...
                    <Link to="/privacy" className="mt-3 inline-flex items-center gap-1.5 text-[13px] hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1a73e8]" style={{ color: C.blue }}>
                      Privacy Policy
              ...
              <div className="min-w-0">
                <article className="divide-y divide-[#e5e7eb]">
                  ...
                  <section id="contact" className="scroll-mt-24 pt-14 sm:pt-16">
                    ...
                    <div className="mt-6">
                      <Link to="/help" className="inline-flex items-center gap-2 text-[15px] hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1a73e8]" style={{ color: C.blue }}>
                        Visit Help
                ...
                <section className="mt-20 border-t border-[#e5e7eb] pt-14 sm:mt-24 sm:pt-16">
                  <div className="max-w-[860px]">
                    ...
                    <div className="mt-8 flex flex-wrap items-center gap-4">
                      ...
                      <Link to="/terms" className="inline-flex h-11 items-center justify-center rounded-full border px-5 text-[15px] hover:bg-[#121317]/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1a73e8]"
                        style={{ borderColor: C.mist, color: C.ink }}>
                        Terms
                      </Link>
                    </div>
