...
function ParentChildWorkspace({ user, accent }) {
  ...
  return <div className={pageClass}>
    ...
    <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
      ...
      <aside className="rounded-2xl border border-[#dadce0] bg-[#f8fafd] p-6"><h2 className="text-base font-medium text-[#202124]">Their learning. Their permission.</h2><ol className="mt-5 space-y-4 text-sm leading-relaxed text-[#5f6368]"><li className="flex gap-3"><span className="font-medium text-[#202124]">1.</span> Request a connection with their Visionary email.</li><li className="flex gap-3"><span className="font-medium text-[#202124]">2.</span> Your child accepts or declines in Connections.</li><li className="flex gap-3"><span className="font-medium text-[#202124]">3.</span> An accepted connection shares subjects and study activity. Private questions and conversations stay private.</li></ol><p className="mt-5 border-t border-[#dadce0] pt-4 text-xs leading-relaxed text-[#5f6368]">Connections currently work between accounts saved in this browser. Cross-device requests will be available when account sync is connected.</p></aside>
    </div>
