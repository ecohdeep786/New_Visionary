...
export interface Conversation { id: string; title: string; messages: Message[]; sessionId?: string; canvasPath?: string; draft: string; updatedAt: string; useForPersonalization: boolean }
